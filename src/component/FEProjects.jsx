      ...
      <article className="grid my-10 items-center xl:gap-6 xl:grid-cols-2">
        ...
        <div className="my-10 align-items-center xl:px-0 xl:mr-5 xl:order-1">
          ...
          <p className="text-lg font-body mb-5 xl:w-[90%]">
            ...
            authorization to keep track of users. RecipeBookmark takes advantage
            of this by assigning posts to users. Each recipe card provides more
            information than a traditional bookmark would.
          </p>
      ...
      <article className="grid my-10 items-center xl:gap-6 xl:grid-cols-2">
        ...
        <div className="my-10 align-items-center xl:px-0 xl:mr-5">
          ...
          <p className="text-lg font-body mb-5 xl:w-[90%]">
            ...
            me to manipulate an extensive database and learn more about my local
            breweries.
          </p>
          <p className="text-lg font-body mb-7 xl:w-[90%] italic">
      ...
      <article className="grid mt-10 mb-0 md:my-10 items-center xl:gap-6 xl:grid-cols-2">
        ...
        <div className="my-10 align-items-center xl:px-0 xl:mr-5 xl:order-1">
          ...
          <p className="text-lg font-body mb-5 xl:w-[90%]">
            ...
            offers a competitive interest rate and a one-time durable card. The
            goal of this bank is to save the world one plastic card at a time.
          </p>
          <p className="text-lg font-body mb-7 xl:w-[90%] italic">
