  ...
  return (
    <section className="grid xl:grid-cols-2">
      <div className="flex px-10 mb-0 bg-darkBlue py-0 2xl:px-[20%] xl:order-2">
        <img
          className="justify-self-center self-end w-full max-w-[510px] mx-auto"
          src="https://codemichaelcode.s3.amazonaws.com/headshot-no-bg.png"
          alt="Michael Olawunmi"
        />
      </div>
      <div className="py-10 px-5 md:px-14 bg-lightBlue xl:text-left 2xl:px-[20%] xl:order-1">
        <h1 className="text-white uppercase leading-[1.1] font-headers text-[3rem] lg:text-[4.5rem] 2xl:mt-10 2xl:text-[6.5rem]">
          <span className="text-[3.5rem] lg:text-[5.5rem] 2xl:text-[8rem]">
            Michael
          </span>
          <br /> Olawunmi
        </h1>
